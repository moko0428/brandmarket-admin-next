...
import ListOpenButton from './components/button/list-open-button';
...
export default function LocationPage() {
  ...
  return (
    <div className="grid grid-cols-1 h-screen">
      {/* 지도 컨테이너 */}
      <div className="col-span-1 relative md:h-[calc(100vh-10rem)] h-screen">
        {loading ? (
          <div className="flex items-center justify-center h-full">
            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-gray-900" />
          </div>
        ) : (
          <Map center={mapCenter} className="w-full h-screen" level={3}>
            {/* 현재 위치 마커 */}
            {currentLocation && (
              <>
      ...
      <div className="">
        ...
        <ListOpenButton setDrawerOpen={setDrawerOpen} drawerOpen={drawerOpen} />
      ...
      <StoreDetailDialog
        ...
        storeOpenTime={isOpenTime(
          selectedStore?.open_time || '00:00',
          selectedStore?.close_time || '00:00'
        )}
      />
    </div>
  );
